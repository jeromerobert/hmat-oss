...
struct hmat_admissibility_builder* hmat_create_admissibility_builder() {
  return reinterpret_cast<struct hmat_admissibility_builder*>(new hmat::AdmissibilityConditionBuilder());
}
