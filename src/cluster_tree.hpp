...
public:
  ...
  // Flag to identify if this node was generated by an Octree
  bool is_octree;
...
public:
    ...
    // Constructor taking a ClusterTree (allows to compute octree cubes if needed)
    explicit AxisAlignedBoundingBox(const ClusterTree& tree);
